...
const messages = defineMessages({
	...
	errorQueueNotice: {
		...
		defaultMessage:
			"If you recently purchased your Bread Hosting server, it is currently in a queue and will appear here as soon as it's ready. <warning>Do not attempt to purchase a new server.</warning>",
	},
	errorSupportNotice: {
		id: 'servers.manage.error.support-notice',
		defaultMessage:
			'If you require personalized support regarding the status of your server, please contact Bread Client Support.',
	},
	errorDetails: { id: 'servers.manage.error.details', defaultMessage: 'Error details:' },
	contactSupportButton: {
		id: 'servers.manage.contact-support-button',
		defaultMessage: 'Contact Bread Client Support',
	},
	reloadButton: { id: 'servers.manage.reload-button', defaultMessage: 'Reload' },
	serversTitle: { id: 'servers.manage.servers-title', defaultMessage: 'Bread Hosting' },
	searchPlaceholder: {
	...
	resubscribeErrorText: {
		...
		defaultMessage: 'An error occurred while resubscribing to your Bread server.',
	},
})
