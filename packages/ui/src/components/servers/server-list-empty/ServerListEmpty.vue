...
const messages = defineMessages({
	...
	noServersDescription: {
		...
		defaultMessage: 'Install mods, invite friends, and play together from Bread Client.',
	},
	...
	playWithFriendsDescription: {
		...
		defaultMessage: 'Invite friends to play your server with one-click play from Bread Client.',
	},
	newServerButton: {
