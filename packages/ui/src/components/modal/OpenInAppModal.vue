...
const messages = defineMessages({
	openingApp: {
		...
		defaultMessage: 'Opening Bread Client',
	},
	whyUseApp: {
		id: 'modal.open-in-app.why-use',
		defaultMessage: 'Why use Bread Client',
	},
	benefitLaunch: {
	...
	openingAutomatically: {
		...
		defaultMessage: 'Bread Client will open automatically...',
	},
	getApp: {
		id: 'modal.open-in-app.get-app',
		defaultMessage: 'Get Bread Client',
	},
})
