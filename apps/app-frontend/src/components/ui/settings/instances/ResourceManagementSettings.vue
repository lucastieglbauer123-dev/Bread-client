...
const messages = defineMessages({
	...
	appDirectoryDescription: {
		...
		defaultMessage:
			'Where Bread Client stores instances and other files. Changes take effect after restarting the app.',
	},
	selectAppDirectory: {
	...
	appCacheDescription: {
		...
		defaultMessage:
			'Clear cached data and download it again from the content service. The app may load more slowly until the cache is rebuilt.',
	},
