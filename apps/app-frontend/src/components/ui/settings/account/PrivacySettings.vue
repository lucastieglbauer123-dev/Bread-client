...
const messages = defineMessages({
	...
	adsConsentIntro: {
		...
		defaultMessage:
			'Ads make Bread Client possible and fund creator payouts. Our partners may store or access cookies in the app to personalize ads and measure performance. You can opt out or manage your preferences below.',
	},
	adsConsentManage: {
	...
	telemetryDescription: {
		...
		defaultMessage:
			'Bread Client collects anonymized analytics and usage data to improve the launcher. By disabling this option, you opt out and your data will no longer be collected.',
	},
	...
	discordRichPresenceDescription: {
		...
		defaultMessage:
			'Show Bread Client as your current activity on Discord. This does not affect Rich Presence added to instances by mods. Requires an app restart.',
	},
})
