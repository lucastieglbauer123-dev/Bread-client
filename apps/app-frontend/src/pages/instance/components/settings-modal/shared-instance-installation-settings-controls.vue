...
const messages = defineMessages({
	...
	unpublishDescription: {
		...
		defaultMessage:
			'Remove this shared instance from the Bread catalog and stop sending updates to anyone using it. Your local instance will not be affected.',
	},
	unlinkButton: {
	...
	unpublishModalBody: {
		...
		defaultMessage:
			"This deletes the shared instance from Bread Client's servers. People using Bread Client will stop receiving updates, but your local instance and its content will stay on this device.",
	},
	unlinkModalHeader: {
